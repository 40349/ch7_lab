...
int main(void)
{
	...
	pRead = fopen("C://c_code/CH7_Lab/Lab2/credit.txt", "r");
	if (NULL == pRead)
	{
		return 0;
	}
	...
	pWrite = fopen("C://c_code/CH7_Lab/Lab2/credit_bin.txt", "wb");
	if (NULL == pWrite)
	{
	...
	printf("\n讀取二進位資料檔案,並格式化輸出如下:\n");
	if ((cfPtr = fopen("C://c_code/CH7_Lab/Lab2/credit_bin.txt", "rb")) == NULL) {
